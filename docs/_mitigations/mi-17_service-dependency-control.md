...
type: preventive
related-risks:
- op-007 # Configuration Drift
- sec-004 # Vulnerable Software in Production
- sec-010 # Dependency and Transitive Supply Chain Compromise
---
...
- FFIEC IT Handbook: Architecture, Infrastructure, and Operations
